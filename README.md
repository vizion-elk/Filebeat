...
1) As administrator, enter the following command in Powershell or download the zip file [here](https://github.com/vizion-elk/Filebeat/archive/6.5.4.zip).

```
Start-BitsTransfer -Source 'https://github.com/vizion-elk/Filebeat/archive/6.5.4.zip' -Destination '${env:USERPROFILE}\Downloads\filebeat.zip'
```
